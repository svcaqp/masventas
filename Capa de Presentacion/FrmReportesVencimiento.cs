...
{
    public partial class FrmReportesVencimiento : DevComponents.DotNetBar.Metro.MetroForm
    {
        public FrmReportesVencimiento()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            this.ReporteInventarioTableAdapter.Fill(this.DemoPracticaVencimiento.ReporteInventario, date_inicial.Value, date_final.Value);
